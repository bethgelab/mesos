...
nvidia-smi:
	docker run -it --rm mesosphere/mesos:1.0.1-2.0.93.ubuntu1404 mesos-execute --master=192.168.99.54:5050 --command='nvidia-smi' --name=gpu-test --docker_image=nvidia/cuda --framework_capabilities="GPU_RESOURCES" --resources="gpus:1"
